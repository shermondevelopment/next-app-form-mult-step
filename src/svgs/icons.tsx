...
export const Profile = ({ width, height, fill }: PropsIcon) => {
  return (
    <svg
      version="1.1"
      id="Layer_1"
    ...
    >
      <g>
        <g>
          <path
            d="M480,309.333c0-15.125-31.168-70.912-46.72-97.813c1.451-7.68,4.053-25.237,4.053-51.52c0-45.547-60.288-160-202.667-160
...
export const Book = ({ width, height, fill }: PropsIcon) => {
  return (
    <svg
      version="1.1"
      id="Layer_1"
    ...
    >
      <g>
        <g>
          <path
            d="M452.611,24.82c-3.605-2.844-8.314-3.877-12.781-2.813L229.16,72.4L18.49,22.008c-4.466-1.065-9.176-0.032-12.781,2.813
...
export const Mail = ({ width, height, fill }: PropsIcon) => {
  return (
    <svg
      version="1.1"
      xmlns="http://www.w3.org/2000/svg"
